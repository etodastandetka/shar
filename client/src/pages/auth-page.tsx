  ...
  export default function AuthPage() {
    ...
    const handlePhoneVerificationRequest = async (userData?: any, token?: string) => {
      console.log("📞 handlePhoneVerificationRequest ВЫЗВАНА");
      ...
      try {
        console.log("📤 Отправляем на /api/auth/request-phone-verification");
    ...
    const checkPhoneVerification = async () => {
      console.log("🔍 checkPhoneVerification ВЫЗВАНА");
      if (!pendingRegistrationData) return;
      
      setIsCheckingVerification(true);
      
      try {
        console.log("📤 Отправляем запрос на /api/auth/check-phone-verification");
        ...
        const result = await response.json();
        console.log("📥 Получен ответ от check-phone-verification:", result);
        
        if (response.ok && result.verified) {
          console.log("✅ Телефон подтвержден, НЕ вызываем registerMutation!");
          ...
          if (result.user) {
            console.log("👤 Пользователь получен, перенаправляем на главную");
        ...
        console.error("❌ Ошибка в checkPhoneVerification:", error);
        toast({
          title: "Ошибка",
